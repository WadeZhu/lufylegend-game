!(function(W){
	// var winWidth, winHeight,winHeight1;
	// winHeight = Math.floor(document.all.game.offsetHeight);
	// winWidth = Math.floor(document.all.game.offsetWidth);
	// if (LGlobal.mobile || true) {
	//     if (winWidth > winHeight) {
	//         winWidth = 640;
	//         winHeight = 1136;
	//     } else {
	//         winHeight1 = 640 * winHeight / winWidth;
	//         winWidth = 640;
	...
	//init(1000/30, "game", winWidth, winHeight, main);
	width = 640, height = 640 / window.innerWidth * window.innerHeight;
	LInit(20, 'game', width, height, main, LEvent.INIT);	

	var loadingLayer,backLayer,stageLayer,scoreLayer,timeLayer,pager,countLayer,gameBody;
	var gameLevel;
	var imglist;
	var stopFlag;
	var MOVE_STEP = 10;
